console.log("rollsData file load");
// const rolls = {
//     "Original": {
//         "basePrice": 2.49,
...
function changeCart()
{
    ...
    //addNewRoll(rollType,rollGlazingText,packSizeText,basePrice);

    const printRoll = new Roll(rollType, rollGlazingText, packSizeText, basePrice);
    addNewRoll(printRoll.type, printRoll.glazing, printRoll.size, printRoll.basePrice);
    //console.log("adding  new roll");
